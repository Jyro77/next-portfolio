        ...
        <div>
            <div className='flex justify-between text-center md:mx-20 md:pt-32 pt-28'>
                ...
                <div className='w-5/6 flex flex-col md:ml-20 mx-10 mt-10'>
                    ...
                    <p className='text-left font-normal mb-5 flex-wrap'>
                        As a vision of applying my knowledge and soft skills to
                        improve the cooperative practices within the development
                        area, sharing and leading changes, tests and situations
                        within the area of development, sharing and leading
                        changes, tests and situations with the highest standards
                        and using emotional intelligence at all times.
                    </p>
                    <a
                        href='#'
